  ...
  return (
    <div className="p-8 max-w-5xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        ...
        {result && (
          <button onClick={() => { setResult(null); setAnnualText(""); }} className="btn-secondary">
      ...
      {!result ? (
        <div className="card p-6 bg-white border border-ink-100 space-y-4">
          <div className="flex items-center justify-between pb-3 border-b border-ink-100">
            <h2 className="font-semibold text-ink-900">Provide Annual Returns & Audited P&L Data</h2>
          ...
          <button onClick={runAnnualAudit} disabled={loading} className="btn-primary w-full justify-center py-3">
            {loading ? (
              <>
        ...
        <div className="space-y-5">
          {/* Summary Banner */}
          <div className="card p-6 bg-white border border-brand-200">
            <div className="flex items-center justify-between">
              <div>
                <span className="text-xs font-semibold uppercase tracking-wider text-brand-600">GSTR-9C Reconciliation Status</span>
                <h2 className="text-2xl font-bold text-ink-900 mt-0.5">Annual Audit Consolidated — {result.financialYear}</h2>
              ...
              <div className="text-right">
                ...
                <div className="text-2xl font-mono font-bold text-red-600 mt-1">{fmt(result.shortTaxPayableDrc03)}</div>
